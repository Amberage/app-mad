...
if (isset($_COOKIE['userData'])) {
    ...
    $tipoCuenta = $userData['userType'];
} else {
    header("Location: ../index.html");
    exit();  
}

if ($tipoCuenta === 'administrador' || $tipoCuenta === 'docente') {
    //Realiza accion
}
